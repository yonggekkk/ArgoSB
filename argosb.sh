...
case "$warp" in x4) if curl -s6m5 icanhazip.com -k >/dev/null; then xryx=ForceIPv4v6 sbyx=prefer_ipv4; else xryx=ForceIPv4 sbyx=ipv4_only; fi ;; *) xryx=ForceIPv4v6 sbyx=prefer_ipv4 ;; esac
}
